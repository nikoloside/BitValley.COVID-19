<template>
  <div id="AboutTeamTermsOfServiceBlock">
    ...
    <p
      ...
      v-bind:class="{ active: isAboutTeamTabActive }"
    >
      渋谷で活躍しているエンジニア・デザイナーチームです。
      <br />
      新型コロナ対策について、小さくとも何かお力添えいただきたく存じます。
      <br />
    ...
    >
      本サイトのデータソースについて
      <br />
      本サイト感染人数に関するデータは〇〇の発表する情報を基に更新しております。
      <br />
      ...
      特に、中国からの感染症状及び予防対策に関する情報は日本での状況に適用できない場合がございます。ご参考の際は、ご注意お願いいたします。
      <br />
